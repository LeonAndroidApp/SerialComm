...
public class SerialParameters {
    ...
    */
    ...
    /**
    Gets stop time setting as an <code>int</code>.
    @return Current stop time setting.
    */
    public String getStoptime() {
	return stoptime;
    }
    /**
    Gets Station ID setting as an <code>int</code>.
    @return Current stop time setting.
    */
    ...
    /**
    Gets Function Code setting as an <code>int</code>.
    @return Current stop time setting.
    */
